...
public class screenShotListerners extends DWSBaseClass implements ITestListener{
	...
	public void onStart(ITestContext context) {
		...
		spark = new ExtentSparkReporter("./src/main/resources/ScreenShotListerns1.html");
		//configure spark
